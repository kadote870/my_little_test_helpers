...
|                                                    |                                                   |                                                         |
|----------------------------------------------------|---------------------------------------------------|---------------------------------------------------------|
| <span style="color:aqua">**aqua**</span>           | ```<span style="color:aqua"> text </span>```      | <span style="color:aqua">**cyjan**</span>               |
| <span style="color:blue">**blue**</span>           | ```<span style="color:blue"> text </span>```      | <span style="color:blue">**niebieski**</span>           |
| <span style="color:fuchsia">**fuchsia**</span>     | ```<span style="color:fuchsia"> text </span>```   | <span style="color:fuchsia">**fuksja**</span>           |
| <span style="color:green">**green**</span>         | ```<span style="color:green"> text </span>```     | <span style="color:green">**zielony**</span>            |
| <span style="color:darkgreen">**darkgreen**</span> | ```<span style="color:darkgreen"> text </span>``` | <span style="color:darkgreen">**ciemno zielony**</span> |
| <span style="color:grey">**grey**</span>           | ```<span style="color:grey"> text </span>```      | <span style="color:grey">**szary**</span>               |
| <span style="color:lime">**lime**</span>           | ```<span style="color:lime"> text </span>```      | <span style="color:lime">**limonkowy**</span>           |
| <span style="color:maroon">**maroon**</span>       | ```<span style="color:maroon"> text </span>```    | <span style="color:maroon">**wiśniowy**</span>          |
